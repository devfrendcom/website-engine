...
const SECTION_MAP = {
  ...
  header_4: dynamic(() => import("@/components/sections/Header4")),
  header_5: dynamic(() => import("@/components/sections/Ankit_Pandey_Header")),
  hero_1: dynamic(() => import("@/components/sections/Hero1")),
  hero_2: dynamic(() => import("@/components/sections/Hero2")),
  hero_3: dynamic(() => import("@/components/sections/Ankit_Pandey_Hero")),
  about_1: dynamic(() => import("@/components/sections/About1")),
  about_2: dynamic(() => import("@/components/sections/Ankit_Pandey_about")),
  services_1: dynamic(() => import("@/components/sections/Services1")),
  services_2: dynamic(() => import("@/components/sections/Ankit_Pandey_services")),
  testimonial_1: dynamic(() => import("@/components/sections/Testimonial1")),
  testimonial_2: dynamic(() => import("@/components/sections/Ankit_Pandey_Testimonials")),
  ...
  footer_3: dynamic(() => import("@/components/sections/Ankit_Pandey_footer")),
