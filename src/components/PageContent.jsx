...
const SECTION_MAP = {
  ...
  header_5: dynamic(() => import("@/components/sections/Abhishek_Singh_Header")),
  hero_1: dynamic(() => import("@/components/sections/Hero1")),
  hero_2: dynamic(() => import("@/components/sections/Hero2")),
  hero_3: dynamic(() => import("@/components/sections/Abhishek_Singh_Hero")),
  about_1: dynamic(() => import("@/components/sections/About1")),
  about_2: dynamic(() => import("@/components/sections/Abhishek_Singh_About")),
  services_1: dynamic(() => import("@/components/sections/Services1")),
  services_2: dynamic(() => import("@/components/sections/Abhishek_Singh_Services")),
  testimonial_1: dynamic(() => import("@/components/sections/Testimonial1")),
  testimonial_2: dynamic(() => import("@/components/sections/Abhishek_Singh_Testimonials")),
  ...
  footer_3: dynamic(() => import("@/components/sections/Abhishek_Singh_Footer")),
